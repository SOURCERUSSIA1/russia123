...
""",
        ...
        [
            InlineKeyboardButton("🔭╎جروب الدعم", url=f"https://t.me/RUSSIA_TEST"),
            InlineKeyboardButton("📡╎قناه السورس", url=f"https://t.me/X_x_RUSSIA_x_X"),
        ],
        [
            InlineKeyboardButton("🎟╎الاوامر", url="https://t.me/RUSSIA_HELP_SOURSE"),
        ],
        [
    ...
    await query.edit_message_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [        
                    InlineKeyboardButton(
                        "⁨⌯ ٰDEV ٰRUSSIA ˹✈🔥˼⁩", url=f"https://t.me/DEV_EL_ZOOZE"
                    ),
                ],
                [                  
                    InlineKeyboardButton(
