...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="جـروب الـدعـم╎🧤​", url=f"https://t.me/RUSSIA_TEST"),
            InlineKeyboardButton(text="قـنـاة السورس╎💡", url=f"https://t.me/X_x_RUSSIA_x_X"),
        ],
        [
            InlineKeyboardButton("🚨╎الاوامـــر╎💁‍♂️", url="https://t.me/RUSSIA_HELP_SOURSE"),
        ],
        [
            InlineKeyboardButton("⁨⌯ RUSSIA • SOURCE ˹🤺˼⁩", url="https://t.me/DEV_EL_ZOOZE"),
        ],
    ]
    return (
